...
function Rules({opacity, onClick}) {
    const display = opacity? 'flex' : 'hidden'
    return (
        <div className={ display + ' absolute medium:h-full medium:w-full md:p-10 md:gap-5 md:rounded-md md:aspect-square top-1/2 left-1/2 -translate-y-1/2 -translate-x-1/2 ' +
